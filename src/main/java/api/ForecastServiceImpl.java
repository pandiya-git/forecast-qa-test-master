...
public class ForecastServiceImpl {
    ...
    public String getForecast(String cityName, LocalDate date) throws IOException {
        ...
        //Call<List<City>> findCityCall = service.findCityByName(cityName.toLowerCase()); commentted the web call
        /* re-direct to MockClient*/
        Call<List<City>> findCityCall = MockClient.getClient().findCityByName(cityName.toLowerCase());
       ...
       // Call<List<Forecast>> forecastCall = service.getForecast(city.getWoeid(), pathDate); commentted the web call
        /* re-direct to MockClient*/
        Call<List<Forecast>> forecastCall = MockClient.getClient().getForecast(city.getWoeid(), pathDate);
